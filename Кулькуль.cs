while (inp == "bup")
{
    Console.WriteLine("Если вы хотите закончить работу, то введите 'exit', если хотите калькулятор, то 'bup'");
    string inp = Console.ReadLine();

    {
        Console.WriteLine("Введите математичскую операцию: '+', '-', '*', '/', '^n', 'sqrt', '1%', 'n!'");
